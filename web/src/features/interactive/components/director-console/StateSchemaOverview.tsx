...
import { retryInteractiveStateSchema, skipInteractiveStateSchema } from '../../api'
import type { ActorStateField, ActorStateSchemaSnapshot, StateSchemaInitializationStatus } from '../../types'

export function StateSchemaOverview({ storyId, schema, initialization, onRefresh }: {
  storyId?: string
  ...
  const [action, setAction] = useState<'retry' | 'skip' | ''>('')
  const [actionError, setActionError] = useState('')

  const runAction = async (kind: 'retry' | 'skip') => {
