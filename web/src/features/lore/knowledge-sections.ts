...
export const KNOWLEDGE_SECTIONS: KnowledgeSection[] = [
  {
    ...
    createNameKey: 'settingPanel.lore.newCharacter',
  },
  {
    id: 'locations',
    ...
    types: ['location'],
    createType: 'location',
    createNameKey: 'settingPanel.lore.newLocation',
  },
  {
    id: 'factions',
    ...
    types: ['faction'],
    createType: 'faction',
    createNameKey: 'settingPanel.lore.newFaction',
  },
  {
    id: 'rules',
    ...
    types: ['world', 'rule'],
    createType: 'rule',
    createNameKey: 'settingPanel.lore.newRule',
  },
  {
    id: 'templates',
    ...
    types: ['other'],
    createType: 'other',
    createNameKey: 'settingPanel.lore.newTemplate',
    tag: '模板',
  },
  {
    id: 'assets',
    ...
    types: ['item', 'other'],
    createType: 'item',
    createNameKey: 'settingPanel.lore.newAsset',
    excludeTag: '模板',
  },
]
