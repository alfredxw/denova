...
export const handlers = [
  ...
  http.get('/api/interactive/tellers', () => HttpResponse.json({ tellers: [{ id: 'classic', name: '经典导演', description: '平衡叙事', random_event_rate: 0.15, tags: ['通用'], custom: false }] })),
  ...
  http.get('/api/settings', () => HttpResponse.json({
    ...
    user: {},
    workspace: {},
    effective: { max_open_tabs: 5, ui_font_family: 'apple-system', ui_font_size: 14, reading_font_family: 'source-han-serif', reading_font_size: 18, interactive_stage_line_height: 1.78 },
