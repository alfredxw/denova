const storyStage = {
  ...
  'storyStage.hideSceneMemory': '隐藏导演台',
  'storyStage.showSceneMemory': '显示导演台',
  'storyStage.sceneMemory': '导演台',
	'storyStage.hud.label': '当前故事态势',
	'storyStage.hud.scene': '场景',
	'storyStage.hud.goal': '当前目标',
	'storyStage.hud.outcome': '刚刚发生',
	'storyStage.hud.stateCommitted': '状态已提交',
	'storyStage.hud.maintenanceHint': '正文与状态已原子提交；记忆和导演规划在后台独立维护。',
	'storyStage.hud.memory.pending': '记忆待整理',
	'storyStage.hud.memory.running': '记忆整理中',
	'storyStage.hud.memory.ready': '记忆已整理',
	'storyStage.hud.memory.failed': '记忆失败',
	'storyStage.hud.plan.keep': '计划保持',
	'storyStage.hud.plan.patch': '计划微调',
	'storyStage.hud.plan.replan': '计划重排',
  ...
  'storyStage.director.title': '导演正在规划故事',
	'storyStage.director.description': '导演会观察已提交回合，并按需保持、微调或重排 director.md；不会改写正文、状态或故事记忆。',
