const planning = {
  ...
  'planning.bookSettingsHeaderPinned': '固定顶部区域',
  'planning.bookSettingsHeaderPinnedDescription': '保持书籍设定始终可见；关闭后将随目录滚动。',
  ...
  'planning.currentChapterPlan': '当前细纲',
  'planning.outlineNavigation': '作品大纲',
  ...
  'planning.create.openMenu': '新建章节或卷',
  'planning.create.chapter': '新建章节',
  'planning.create.volume': '新建卷',
  'planning.create.chapterDescription': '章节将追加到所选卷，并按当前章节命名格式创建。',
  'planning.create.volumeDescription': '新卷会与首章一起创建，避免产生无法进入版本历史的空目录。',
  'planning.create.chapterTitle': '章节标题（不含序号）',
  'planning.create.volumeTitle': '卷名',
  'planning.create.firstChapterTitle': '首章标题（不含序号）',
  'planning.create.targetVolume': '所属卷',
  'planning.create.chapterOrdinal': '第{{order}}章',
  'planning.create.inVolume': '在此处新建章节',
  'planning.create.volumeExists': '已存在同名卷，请使用其他名称。',
  'planning.create.invalidFormat': '当前章节或卷命名格式无法生成有效且唯一的路径，请先在设置中修正。',
