const planning = {
  ...
  'planning.bookSettingsHeaderPinned': 'Keep the top section pinned',
  'planning.bookSettingsHeaderPinnedDescription': 'Keep Book Settings visible; turn this off to scroll it with the outline.',
  ...
  'planning.create.openMenu': 'Create chapter or volume',
  'planning.create.chapter': 'New Chapter',
  'planning.create.volume': 'New Volume',
  'planning.create.chapterDescription': 'The chapter will be appended to the selected volume using the current chapter naming format.',
  'planning.create.volumeDescription': 'The new volume and its first chapter are created together, avoiding an empty folder that version history cannot preserve.',
  'planning.create.chapterTitle': 'Chapter title (without number)',
  'planning.create.volumeTitle': 'Volume title',
  'planning.create.firstChapterTitle': 'First chapter title (without number)',
  'planning.create.targetVolume': 'Volume',
  'planning.create.chapterOrdinal': 'Chapter {{order}}',
  'planning.create.inVolume': 'New chapter here',
  'planning.create.volumeExists': 'A volume with this title already exists. Use a different title.',
  'planning.create.invalidFormat': 'The current chapter or volume naming format cannot produce a valid unique path. Correct it in Settings first.',
