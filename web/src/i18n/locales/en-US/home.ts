const home = {
  ...
  'home.deleteBookDescription': 'Choose how to handle "{{name}}". Soft delete only hides it from the bookshelf. Hard delete removes the directory from disk and cannot be undone inside Nova.',
  ...
  'home.hardDeleteBook': 'Delete Files',
