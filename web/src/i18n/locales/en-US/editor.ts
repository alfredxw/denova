const editor = {
  ...
  'editor.review.mode': 'Editor mode',
  'editor.review.editMode': 'Edit',
  'editor.review.reviewMode': 'Review',
  ...
  'editor.review.enterFailed': 'Could not enter Review mode. Save or reload the document and try again.',
