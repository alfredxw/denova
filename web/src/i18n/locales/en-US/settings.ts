const settings = {
  ...
  'settings.model.routingHint': 'Provider presets only supply defaults. You can enter any provider ID, choose any installed API protocol, and override its endpoint independently.',
  ...
  'settings.model.profileProviderPlaceholder': 'Preset or custom provider ID',
  'settings.model.profileProviderOpenAI': 'OpenAI',
  'settings.model.profileProviderDeepSeek': 'DeepSeek',
  'settings.model.profileProviderCompatible': 'OpenAI-compatible endpoint',
  ...
  'settings.model.profileProtocolGoogleGenerativeAI': 'Google Generative AI',
