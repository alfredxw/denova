const settings = {
  ...
  'settings.interactive.ruleLoreLimitKB': 'Global Rule Lore Limit (KB)',
  'settings.interactive.ruleLoreLimitHelp': 'Every enabled rule lore entry is loaded in full for the Director and Game Agent. Exceeding this limit fails explicitly instead of silently truncating rules.',
