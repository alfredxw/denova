const settings = {
  ...
  'settings.imageApi.addProfile': 'Add Image API',
  'settings.imageApi.defaultOutputFormat': 'Default Output Format',
  'settings.imageApi.defaultProfile': 'Default Image API',
  'settings.imageApi.defaultQuality': 'Default Quality',
  'settings.imageApi.defaultSize': 'Default Size',
  'settings.imageApi.deleteProfile': 'Delete image API profile',
  'settings.imageApi.profileAliasLabel': 'Alias',
  'settings.imageApi.profileAliasPlaceholder': 'Cover / Illustration',
  'settings.imageApi.profileEmpty': 'Inheriting {{count}} image API profile(s). Add one with Base URL, API Key, model, and defaults.',
  ...
  'settings.imageApi.profileName': 'Image API {{index}}',
  'settings.imageApi.profileUntitled': 'Untitled Image API',
  'settings.imageApi.profiles': 'Image API Profiles',
  ...
  'settings.section.imageApi': 'Image API',
