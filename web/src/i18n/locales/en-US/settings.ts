const settings = {
  ...
  'settings.labs.continualLearningHint': 'Enables the user-level Harness State page under Agents. One current State is shared by every Project; Agent rebuilds and recovery always load the latest content.',
