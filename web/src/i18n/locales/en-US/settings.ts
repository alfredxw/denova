const settings = {
  ...
  'settings.model.routingHint': 'Provider controls endpoint defaults; API protocol controls the wire format. OpenAI defaults to Responses, DeepSeek defaults to Chat Completions, and legacy profiles stay on Chat Completions.',
