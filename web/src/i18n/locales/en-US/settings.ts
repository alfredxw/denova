const settings = {
  ...
  'settings.agent.contextHandoffLimitKB': 'Context Handoff Safety Limit (KB)',
  ...
  'settings.notifications.systemEnabled': 'Enable System Notifications',
  'settings.notifications.systemHint': 'Off by default; the app never asks for permission on first launch, and the in-app Task Center always remains available.',
