const settings = {
  ...
  'settings.terminal.codexCommand': 'Codex CLI Launch Command',
  'settings.terminal.claudeCommand': 'Claude Code Launch Command',
  'settings.terminal.maxSessions': 'Max Concurrent Sessions (1–64)',
  'settings.terminal.scrollbackKB': 'Scrollback Buffer (KB, 1–4096)',
  'settings.terminal.hint': 'CLI launch commands accept a program name, full path, and quoted arguments, for example npx @openai/codex. Terminal tabs run commands on this machine as your account; turn them off to block access.',
