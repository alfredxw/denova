const agents = {
  ...
  'agents.tool.subAgentParallelismNote': 'The main Agent works independently by default and delegates only when the user or a Skill explicitly requires it. This limits concurrent child tasks under one parent conversation; new starts are rejected individually when the limit is reached.',
  ...
  'agents.builtIn.tellerRead.value': 'Read current narrative styles, Game Presets, image presets, selected presets, and user-referenced presets.',
  'agents.builtIn.tellerWrite.title': 'Write Presets',
  'agents.builtIn.tellerWrite.value':
    'Generate create / update plans for backend validation and saving as narrative styles, Game Presets, or image presets.',
  ...
  'agents.tab.behavior': 'Behavior',
  'agents.tab.capabilities': 'Capabilities',
  'agents.tab.context': 'Context',
  'agents.tab.resolved': 'Resolved',
  ...
  'agents.section.resolved': 'Resolved Definition',
  ...
  'agents.resolved.contract': 'Contract',
  'agents.resolved.revision': 'Revision',
  'agents.resolved.instructions': 'Instructions',
  'agents.resolved.bytes': '{{count}} bytes',
  'agents.resolved.tools': 'Contract-allowed tools',
  'agents.resolved.skills': 'Skill policy',
  'agents.resolved.context': 'Context bindings',
  'agents.resolved.toolNames': 'Contract-allowed tool names',
} as const
