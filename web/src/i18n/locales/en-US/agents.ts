const agents = {
  ...
  'agents.field.contextPressureScope': 'Pressure Scope',
  'agents.field.toolResultCleanupThreshold': 'Tool Cleanup Threshold (%)',
  'agents.field.toolResultCleanupTarget': 'Tool Cleanup Target (%)',
  'agents.field.toolResultCleanupMinTokens': 'Minimum Cleanup Savings (tokens)',
  'agents.field.toolResultKeepRecent': 'Protected Recent Tool Groups',
  'agents.field.toolResultKeepRecentTokens': 'Protected Tool Result Window (tokens)',
  'agents.field.toolResultWarmSuffixTokens': 'Warm Suffix Rewrite Limit (tokens)',
  'agents.field.toolResultEagerMinTokens': 'Eager Receipt Minimum (tokens)',
  ...
  'agents.field.compactionRecoveryBand': 'Compaction Recovery Factor (%)',
  'agents.field.compactionMaxFailures': 'Maximum Consecutive Failures',
  ...
  'agents.option.pressureBodyAfterPrefix': 'Mutable body after stable prefix',
  'agents.option.pressureTotal': 'Complete provider input',
  ...
  'agents.context.compactionNote': 'Model profile context window tokens default to 400K. At 85% pressure by default, Denova compacts older history. The recovery band controls the post-compaction headroom required before automatic continuation.',
  'agents.context.compactionTargetNote': 'Configure checkpoint output policy. The default cache-safe compaction fork reuses the primary Agent request prefix, keeps the latest 1 raw turn, and compresses older context to 5%-20%. Dense context should use the upper end so key intent, story changes, and pending work are not over-compressed.',
  ...
  'agents.context.toolResultCleanupNote': 'At 70% pressure by default, Denova can replace eligible old tool-result bodies with deterministic recovery placeholders in one batch down to 60%. Current-turn, recent, failed, mutating, and explicitly protected results remain intact; warm cache rewrites obey the suffix limit.',
