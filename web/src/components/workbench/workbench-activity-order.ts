...
export type ActivityItemID = 'writing' | 'story' | 'market' | 'extensions' | 'lore' | 'teller' | 'versions' | 'books' | 'agentchat' | 'skills' | 'agents' | 'automations' | 'trajectory'
...
const DEFAULT_ACTIVITY_ORDER: ActivityItemID[] = ['writing', 'story', 'agentchat', 'trajectory', 'lore', 'teller', 'versions', 'books', 'skills', 'agents', 'automations', 'market', 'extensions']
