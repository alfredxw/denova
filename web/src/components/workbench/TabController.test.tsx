...
describe('TabController', () => {
  it('persists Lore as a singleton workspace tab and renders its dedicated label', () => {
    ...
    expect(loreTab).toHaveAttribute('data-state', 'active')
    expect(loreTab.className).toContain('data-[state=active]:!bg-[var(--nova-active)]')
    expect(loreTab.className).toContain('data-[state=active]:!shadow-none')
