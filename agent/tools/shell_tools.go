...
type commandInput struct {
	...
	Description    string            `json:"description,omitempty" jsonschema:"maxLength=256" jsonschema_description:"Short user-facing description of what the command is intended to do, written in the user's language. Do not repeat the command."`
