// Package runtime coordinates durable Agent operations independently of
...
// idempotent across process restarts. Application stores remain the canonical
// source of user content; the runtime journal stores coordination
