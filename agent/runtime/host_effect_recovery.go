...
// but they cannot authorize downstream side effects for an uncommitted cycle.
...
// actor lane.
func (r *Runtime) ReconcileHostEffects(ctx context.Context, binding BindingRef) error {
