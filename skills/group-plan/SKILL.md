...
1. 使用 read 读取 `setting/outline.md`，确认长期主线、卷章方向和阶段目标
2. 使用 read 读取 `setting/progress.md` 和 `setting/character-states.md`，并结合常驻资料库和资料库索引确认当前实际写作落点、角色当前状态和关键长期设定
...
7. 使用 write 写入 `setting/chapter-groups/groupXX-情节目标.md`
