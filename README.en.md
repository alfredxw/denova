...
- **Image creation**: generate chapter illustrations, interactive images, and book covers through OpenAI-compatible image model profiles, with built-in MiniMax provider support for additional image generators, and a UI to preview and manage results.
