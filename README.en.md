...
- **Writing Mode**: fiction-focused Markdown editing, multiple tabs, regex find and replace, recoverable workspace-wide replacement, chapter statistics, outlines, chapter-group plans, progress tracking, document comments, Change Review, existing novel import, and TXT / EPUB (with a chapter table of contents) book export.
