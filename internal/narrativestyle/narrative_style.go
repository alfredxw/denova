// Package narrativestyle owns the stable cross-module contract for narrative
// style identity and mode availability. Prompt content remains with the
// interactive Teller library.
package narrativestyle
