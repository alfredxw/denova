...
func TestModelFacingSourceRejectsBilingualSplitLiterals(t *testing.T) {
	...
	paths := []string{
		...
		"internal/app/interactive/conversation_director.go",
		"internal/app/interactive/conversation_history.go",
		"internal/app/interactive/director_documents.go",
		...
		"internal/interactive/director_plan_patch.go",
		"internal/interactive/director_plan_submission.go",
