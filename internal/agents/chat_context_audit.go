...
func (l *contextBuildLog) auditForMessages(messages []*agent.Message) []ContextLedgerPart {
	if l == nil || l.ledger == nil {
		return nil
	}
...
func contextLedgerPartsForConversation(log *contextBuildLog, conversation Conversation, messages []*agent.Message) []ContextLedgerPart {
