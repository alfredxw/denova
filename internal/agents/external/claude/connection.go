...
func (c *Client) Models(context.Context) (external.Models, error) {
	// CLI aliases resolve using the user's account/provider. They are choices,
	// not an assertion that every account has access to every model.
	return external.Models{DefaultID: "default", Items: []external.Model{
		{ID: "default", DisplayName: "Default", Efforts: []string{}},
		{ID: "sonnet", DisplayName: "Sonnet", Efforts: []string{"low", "medium", "high"}},
		{ID: "opus", DisplayName: "Opus", Efforts: []string{"low", "medium", "high", "max"}},
		{ID: "haiku", DisplayName: "Haiku", Efforts: []string{}},
	}}, nil
}
