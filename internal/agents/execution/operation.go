...
func (r *Operation) Wait(ctx context.Context) agentrun.Outcome {
	...
	// could return another command's output. Live Operation observation sees
...
func (r *Operation) persistPreparedContextCompactionHealth(publication agentcompaction.Publication) {
...
func (r *Operation) persistPreparedContextCompaction() (bool, error) {
