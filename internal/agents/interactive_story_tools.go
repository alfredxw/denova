...
func newInteractiveHistoryTools(ctx InteractiveStoryToolContext) ([]agent.BaseTool, error) {
...
func newInteractiveTurnTools(ctx InteractiveStoryToolContext) ([]agent.BaseTool, error) {
...
func newSubmitInteractiveTurnTool(description string, submit func(context.Context, interactive.TurnSubmissionInput) (interactive.TurnSubmissionReceipt, error)) (agent.InvokableTool, error) {
	info, err := agent.GoStruct2ToolInfo[submitInteractiveTurnToolSchema](interactiveTurnSubmissionToolName, description)
	if err != nil {
		return nil, err
	}
