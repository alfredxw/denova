...
func TestBuildContextCompactionUsesExplicitSourceTranscript(t *testing.T) {
	...
	var capturedSource []*agent.Message
	var capturedReference string
	summarizeContextForCompaction = func(_ context.Context, _ *config.Config, _ string, _ string, source []*agent.Message, referenceContext string, _ int, _ contextCompactionPolicy, _ func(int, string)) (string, int, error) {
...
func TestBuildContextCompactionUsesContextCompactionTargetRange(t *testing.T) {
	...
	summarizeContextForCompaction = func(_ context.Context, _ *config.Config, _ string, _ string, _ []*agent.Message, _ string, _ int, policy contextCompactionPolicy, _ func(int, string)) (string, int, error) {
...
func TestBuildContextCompactionEmitsStreamingSummaryDelta(t *testing.T) {
	...
	summarizeContextForCompaction = func(_ context.Context, _ *config.Config, _ string, _ string, _ []*agent.Message, _ string, _ int, _ contextCompactionPolicy, emitDelta func(int, string)) (string, int, error) {
		emitDelta(1, "第一段")
		emitDelta(1, "第二段")
