...
func resolveContextPressurePolicy(cfg *config.Config, agentKind string, messages []*agent.Message) ContextPressurePolicy {
	...
	return ContextPressurePolicy{
		AgentKind:               agentKind,
		Enabled:                 settings.CompactionEnabled || settings.ToolResultRetentionEnabled,
		CompactionEnabled:       settings.CompactionEnabled,
		CleanupEnabled:          settings.ToolResultRetentionEnabled,
		Scope:                   ContextPressureScope(settings.ContextPressureScope),
		ContextWindowTokens:     model.ContextWindowTokens,
		ReservedTokens:          completionReserve + toolReserve,
		CleanupThreshold:        settings.ToolResultCleanupThreshold,
		CleanupTarget:           settings.ToolResultCleanupTarget,
		CleanupMinTokens:        settings.ToolResultCleanupMinTokens,
		KeepRecentGroups:        settings.ToolResultKeepRecent,
		KeepRecentTokens:        settings.ToolResultKeepRecentTokens,
		WarmSuffixTokens:        settings.ToolResultWarmSuffixTokens,
		EagerMinTokens:          settings.ToolResultEagerMinTokens,
		EagerMinContextRatio:    0.15,
		CompactionThreshold:     settings.CompactionThreshold,
		CompactionRecoveryBand:  settings.CompactionRecoveryBand,
