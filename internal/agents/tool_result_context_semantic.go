...
func filterSemanticToolContextMessages(messages []*agent.Message, policy ToolResultContextPolicy) []*agent.Message {
	return filterToolContextMessages(messages, policy, true)
}

func filterToolContextMessages(messages []*agent.Message, policy ToolResultContextPolicy, retainNormalResults bool) []*agent.Message {
