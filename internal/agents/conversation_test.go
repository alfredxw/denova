...
func TestSessionConversationPreparesIncrementalCompactionWithoutAdvancingCanonicalCheckpoint(t *testing.T) {
	...
	summarizeContextForCompaction = func(_ context.Context, _ *config.Config, _ string, existingCheckpoint string, source []*agent.Message, _ string, _ int, _ contextCompactionPolicy, _ func(int, string)) (string, int, error) {
...
func (c *finalContextLedgerReportingConversation) ContextLedgerPartsForMessages(messages []*agent.Message) []ContextLedgerPart {
