...
func finishLLMCallTrace(span *traceSpanHandle, callID, agentKind, source, mode, modelName string, callIndex int, msg *agent.Message, err error, extra map[string]any) {
