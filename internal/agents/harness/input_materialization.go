...
type InputMaterializer interface {
	PlanHarnessInputMaterialization(context.Context, InputMaterializationRequest) (agentrun.InputMaterializationPlan, error)
	MaterializeHarnessInput(context.Context, InputMaterializationRequest, agentrun.InputMaterializationPlan) (agentrun.InputMaterializationReceipt, error)
}
...
func (e *bindingHarnessEngine) MaterializeInput(
	...
	receipt, err := e.owner.inputMaterializer.MaterializeHarnessInput(ctx, materialization, agentrun.InputMaterializationPlanFromRuntime(plan))
...
func (e *bindingHarnessEngine) acceptedInputMaterializationRequest(
	...
	if e == nil || e.owner == nil {
		return InputMaterializationRequest{}, fmt.Errorf("materialize agent harness input: engine is nil")
	}
