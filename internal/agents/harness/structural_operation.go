...
func (s *Service) ExecuteStructuralOperation(ctx context.Context, spec agentstructural.Spec) (agentstructural.Result, error) {
...
func (h *coordinator) executeContextStructuralOperation(ctx context.Context, spec agentstructural.Spec) (agentstructural.Result, error) {
	...
	registration, err := h.engine.register(spec.Ref.SpecRef, command, TurnSpec{
