...
func (s *Service) RuntimeStatusProjection(ctx context.Context, options agentrun.Options) (agentrun.RuntimeStatus, error) {
...
func (s *Service) closeRuntimeBindings(ctx context.Context, selector runstate.BindingSelector) error {
	if s == nil || s.coordinator == nil || s.coordinator.runtime == nil {
...
func (s *Service) CloseWorkspaceBindings(ctx context.Context, workspace string) error {
...
func (s *Service) CloseForegroundWorkspaceBindings(ctx context.Context, workspace string) error {
...
func (s *Service) CloseAgentChatSessionBindings(ctx context.Context, workspace, sessionID string) error {
...
func (s *Service) CloseProjectSessionBindings(ctx context.Context, projectID, sessionID string) error {
...
func (s *Service) CloseProjectBindings(ctx context.Context, projectID string) error {
...
func (s *Service) CloseSessionBindings(ctx context.Context, agentKind, workspace, sessionID string) error {
...
func (s *Service) CloseStoryBindings(ctx context.Context, workspace, storyID, branchID string) error {
