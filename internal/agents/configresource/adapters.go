...
type configResourceAdapter struct {
	...
	list       func(context.Context, ReadRequest) (any, error)
	get        func(context.Context, ReadRequest) (any, error)
	apply      func(context.Context, Mutation) (any, error)
}

func (a configResourceAdapter) Descriptor() Descriptor { return a.descriptor }

func (a configResourceAdapter) List(ctx context.Context, request ReadRequest) (any, error) {
	if a.list == nil {
...
func (a configResourceAdapter) Get(ctx context.Context, request ReadRequest) (any, error) {
	if a.get == nil {
...
func (a configResourceAdapter) Apply(ctx context.Context, mutation Mutation) (any, error) {
	if a.apply == nil {
