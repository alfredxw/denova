...
func toolMutationOrigin(options agentrun.Options) ToolMutationOrigin {
...
func DecodeCommittedToolMutationHostEffect(binding runstate.BindingRef, effect runstate.HostEffect) (CommittedToolMutation, error) {
	...
	return CommittedToolMutation{
		EffectID: agentrun.HostEffectID(effect.ID), Binding: productBinding, RuntimeOperation: agentrun.OperationID(effect.OperationID),
