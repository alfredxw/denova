...
func executionModeForTool(manifest toolresult.Manifest) toolExecutionMode {
	switch manifest.Execution {
	case agenttool.ToolExecutionChild, agenttool.ToolExecutionInteractiveWait:
	...
	case agenttool.ToolExecutionParallelRead:
		return toolExecutionParallelRead
	case agenttool.ToolExecutionWorkspaceExclusive, agenttool.ToolExecutionSessionExclusive, agenttool.ToolExecutionConfigExclusive:
