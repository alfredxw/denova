...
var catalogZH = map[string]string{
	...
	"api.ask.failed":                    "提交交互决定时发生内部错误，具体原因见诊断信息。",
	"api.ask.definitionMismatch":        "审批校验失败：当前执行定义与本轮快照不一致。请停止本轮并重新发起。",
	"api.ask.stale":                     "该交互已失效，请刷新会话状态。",
	"api.ask.conflict":                  "该交互已通过另一项决定完成，请刷新会话状态。",
	"api.ask.notFound":                  "找不到该交互，请刷新会话状态。",
	"api.ask.invalidAnswer":             "回答内容不符合该交互要求，请检查选项或输入。",
	...
	"agentRuntime.toolNotExecuted":           "工具未开始执行，未产生修改。",
	...
	"api.lore.materialUploadRequired":            "请选择素材文件。",
...
var catalogEN = map[string]string{
	...
	"api.ask.failed":                    "An internal error prevented submitting the decision. See the diagnostic details.",
	"api.ask.definitionMismatch":        "Approval validation failed: the current execution definition differs from this turn's snapshot. Stop this turn and start a new one.",
	"api.ask.stale":                     "This interaction is no longer active. Refresh the conversation state.",
	"api.ask.conflict":                  "This interaction was already resolved with another decision. Refresh the conversation state.",
	"api.ask.notFound":                  "This interaction could not be found. Refresh the conversation state.",
	"api.ask.invalidAnswer":             "The answer does not meet this interaction's requirements. Check the options or input.",
	...
	"agentRuntime.toolNotExecuted":           "The tool did not start. No changes were made.",
	...
	"api.lore.materialUploadRequired":            "Choose a material file.",
