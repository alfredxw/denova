...
var catalogZH = map[string]string{
	...
	"api.terminal.invalidProfile":             "未知的终端启动类型，请重新打开终端标签页",
	"api.terminal.invalidLaunchCommand":       "CLI 启动命令无效，请在设置中检查 Codex CLI 或 Claude Code 的命令",
...
var catalogEN = map[string]string{
	...
	"api.terminal.invalidProfile":             "Unknown terminal launch profile. Reopen the terminal tab.",
	"api.terminal.invalidLaunchCommand":       "The CLI launch command is invalid. Check the Codex CLI or Claude Code command in Settings.",
