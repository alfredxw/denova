...
// Defaults intentionally sit well above Denova's 128 KiB context-fragment
// floor while preventing count-bounded collections from retaining gigabytes.
...
// UTF-8 JSON. Zero values select conservative production defaults well above
// the 128 KiB context-fragment floor used by Denova.
