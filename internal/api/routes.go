...
func (s *Server) registerRoutes(h *hertzserver.Hertz) {
	...
	api := h.Group("/api")
	{
		...
		api.POST("/projects/:project_id/files/operations", apiHandlers.HandleProjectFileOperations)
		api.GET("/projects/:project_id/book", apiHandlers.HandleProjectBookSnapshot)
		api.GET("/projects/:project_id/book/tree", apiHandlers.HandleProjectBookTree)
		api.GET("/projects/:project_id/book/summary", apiHandlers.HandleProjectBookSummary)
		api.PATCH("/projects/:project_id/book/chapter-status", apiHandlers.HandleProjectBookChapterStatus)
		api.GET("/projects/:project_id/book/lore/items", apiHandlers.HandleProjectLoreItems)
		api.POST("/projects/:project_id/book/lore/items", apiHandlers.HandleProjectLoreItemCreate)
		api.PUT("/projects/:project_id/book/lore/items/:id", apiHandlers.HandleProjectLoreItemUpdate)
		api.DELETE("/projects/:project_id/book/lore/items/:id", apiHandlers.HandleProjectLoreItemDelete)
		api.GET("/projects/:project_id/book/document-review", apiHandlers.HandleProjectDocumentReview)
		api.POST("/projects/:project_id/book/document-comments", apiHandlers.HandleProjectDocumentCommentCreate)
		api.PATCH("/projects/:project_id/book/document-comments/:id", apiHandlers.HandleProjectDocumentCommentUpdate)
		api.DELETE("/projects/:project_id/book/document-comments/:id", apiHandlers.HandleProjectDocumentCommentDelete)
		...
		api.GET("/config-manager/stream", apiHandlers.HandleConfigManagerTaskStream)
		api.GET("/config-manager/active", apiHandlers.HandleConfigManagerActive)
		api.POST("/config-manager/recovery", apiHandlers.HandleConfigManagerRecovery)
		...
		api.POST("/config-manager/asks/:ask_id/answer", apiHandlers.HandleConfigManagerAskAnswer)
		api.POST("/config-manager/asks/:ask_id/cancel", apiHandlers.HandleConfigManagerAskCancel)
		...
		api.POST("/agent-chat/chat", apiHandlers.HandleAgentChat)
		api.GET("/agent-chat/chat/stream", apiHandlers.HandleAgentChatStream)
		api.GET("/agent-chat/chat/active", apiHandlers.HandleAgentChatActive)
		api.POST("/agent-chat/chat/commands", apiHandlers.HandleAgentChatCommand)
		api.POST("/agent-chat/chat/recovery", apiHandlers.HandleAgentChatRecovery)
		api.POST("/agent-chat/chat/context-analysis", apiHandlers.HandleAgentChatContextAnalysis)
		api.GET("/agent-chat/session/messages", apiHandlers.HandleAgentChatMessages)
		api.POST("/agent-chat/session/asks/:ask_id/answer", apiHandlers.HandleAgentChatAskAnswer)
		api.POST("/agent-chat/session/asks/:ask_id/cancel", apiHandlers.HandleAgentChatAskCancel)
		api.POST("/agent-chat/command", apiHandlers.HandleAgentChatSlashCommand)
		api.GET("/terminal/sessions", apiHandlers.HandleTerminalSessions)
		api.POST("/terminal/sessions", apiHandlers.HandleTerminalSessionCreate)
