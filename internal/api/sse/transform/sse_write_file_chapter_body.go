...
func (m *writeFileChapterBodySSEMiddleware) processToolCall(ev appsvc.AgentEvent, next SSEEventHandler) error {
...
func (m *writeFileChapterBodySSEMiddleware) processToolTarget(ev appsvc.AgentEvent, next SSEEventHandler) error {
	id := eventDataString(ev.Data, "id")
	name := eventDataString(ev.Data, "name")
	target := eventDataString(ev.Data, "target")
...
func (m *writeFileChapterBodySSEMiddleware) processToolArgsDelta(ev appsvc.AgentEvent, next SSEEventHandler) error {
	id := eventDataString(ev.Data, "id")
	name := eventDataString(ev.Data, "name")
...
func (m *writeFileChapterBodySSEMiddleware) forwardChapterBodyProgressDelta(ev appsvc.AgentEvent, next SSEEventHandler, state *writeFileChapterBodySSEState) error {
...
func (m *writeFileChapterBodySSEMiddleware) processToolEnd(ev appsvc.AgentEvent, next SSEEventHandler) error {
	id := eventDataString(ev.Data, "id")
	if id == "" {
		return next(ev)
	}
...
func (m *writeFileChapterBodySSEMiddleware) flushChapterBodyProgress(ev appsvc.AgentEvent, next SSEEventHandler, state *writeFileChapterBodySSEState) error {
...
func (m *writeFileChapterBodySSEMiddleware) shouldProcessTool(ev appsvc.AgentEvent, name string) bool {
	return eventDataString(ev.Data, "agent_kind") == appsvc.AgentKindIDE && name == "write_file"
}
