...
func builtinTeller(id, name, description, systemPrompt, turnContext string) Teller {
...
// These two strings are intentionally unchanged from the previous built-in.
// They are a byte-for-byte regression boundary for this feature.
