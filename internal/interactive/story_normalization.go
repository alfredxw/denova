...
func normalizeStorySummary(story StorySummary) StorySummary {
	...
	story.PresentationSettings = NormalizeStoryPresentationSettings(story.PresentationSettings)
...
func normalizeStoryMeta(meta StoryMeta) StoryMeta {
	...
	meta.PresentationSettings = NormalizeStoryPresentationSettings(meta.PresentationSettings)
