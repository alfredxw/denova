...
func (s *ChatAppService) AnalyzeContext(ctx context.Context, req agent.ChatRequest) (agent.ContextAnalysis, error) {
	...
	return agent.BuildIDEContextAnalysis(&runtime.cfg, runtime.state, runtime.ideTeller, runtime.bookService, compaction, pending, req, conversation)
}
...
func (a *App) CompactContextCommand(ctx context.Context, commandID string) (agent.ContextCompactionResult, error) {
