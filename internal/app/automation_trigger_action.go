...
func (s *AutomationAppService) processDurableBuiltInTrigger(
	ctx context.Context,
...
func (s *AutomationAppService) processDurableBuiltInTriggerWithStarter(
	ctx context.Context,
	snap *automationWorkspaceSnapshot,
	store *automation.Store,
	now time.Time,
...
func (s *AutomationAppService) claimOrResumeBuiltInTrigger(
	ctx context.Context,
	snap *automationWorkspaceSnapshot,
	store *automation.Store,
	now time.Time,
...
func (s *AutomationAppService) reconcileLegacyBuiltInTriggerState(store *automation.Store, task automation.Task, trigger automation.TriggerDefinition, stateKey string, nextState automation.TriggerState, match automation.TriggerMatch) (bool, error) {
	var found bool
