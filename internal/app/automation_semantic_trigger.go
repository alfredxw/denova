...
func (s *AutomationAppService) processDurableSemanticTrigger(
	ctx context.Context,
...
func (s *AutomationAppService) processDurableSemanticTriggerWithStarter(
	ctx context.Context,
	snap *automationWorkspaceSnapshot,
	store *automation.Store,
	now time.Time,
...
func (s *AutomationAppService) claimOrResumeSemanticTrigger(
	ctx context.Context,
	snap *automationWorkspaceSnapshot,
	store *automation.Store,
	now time.Time,
...
func (s *AutomationAppService) semanticTriggerClaim(snap *automationWorkspaceSnapshot, now time.Time, task automation.Task, trigger automation.TriggerDefinition, state automation.TriggerState) (automation.TriggerEvaluationRecord, bool, error) {
...
func (s *AutomationAppService) evaluateClaimedSemanticTrigger(
	ctx context.Context,
	snap *automationWorkspaceSnapshot,
	store *automation.Store,
	now time.Time,
...
func (s *AutomationAppService) reconcileDurableTriggerAction(
	ctx context.Context,
	snap *automationWorkspaceSnapshot,
	store *automation.Store,
	task automation.Task,
