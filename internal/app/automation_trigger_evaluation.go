...
func (s *AutomationAppService) evaluateTrigger(_ context.Context, snap *automationWorkspaceSnapshot, now time.Time, _ string, task automation.Task, trigger automation.TriggerDefinition) (automation.TriggerMatch, automation.TriggerState, bool, error) {
