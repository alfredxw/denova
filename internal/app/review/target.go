...
// targetResolver is the application-level adapter between the
...
func NewTargetResolver(workspace string, files *book.Service) documentreview.SnapshotResolver {
...
func (r targetResolver) ResolveReviewTarget(_ context.Context, target documentreview.Target) (documentreview.ResolvedTarget, error) {
