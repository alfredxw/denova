...
// SystemPromptCompositionLog remains as a source-compatible name for callers
// that store the composition in RunOptions.
type SystemPromptCompositionLog = SystemPromptComposition
