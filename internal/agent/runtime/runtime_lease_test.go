...
func TestRuntimeOpenHoldsMemoryBindingLeaseUntilClose(t *testing.T) {
	...
	binding := runstate.WritingBinding{Workspace: "/book", SessionID: "memory-lease"}
...
func TestRuntimeOpenHoldsFileBindingLeaseAcrossStores(t *testing.T) {
	...
	binding := runstate.WritingBinding{Workspace: "/book", SessionID: "file-lease"}
...
func TestCloseBindingWaitsForPendingOpenAndPreventsOverlappingHarness(t *testing.T) {
	...
	binding := runstate.WritingBinding{Workspace: "/book", SessionID: "pending-close"}
...
func assertOpenWaitsForLease(t *testing.T, runtime *runstate.Runtime, binding runstate.Binding) {
	t.Helper()
