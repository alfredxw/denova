...
func checkpointTestBinding(sessionID string) BindingRef {
	return BindingRef{Kind: BindingWriting, Profile: ProfileWriting, Workspace: "/book", SessionID: sessionID}
}
...
func TestRuntimeReopensFromCheckpointAndRejectsHistoricalDuplicateCommand(t *testing.T) {
	...
	binding := WritingBinding{Workspace: "/book", SessionID: "runtime-checkpoint-reopen"}
