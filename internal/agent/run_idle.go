...
func waitForRunnerEvent(ctx context.Context, events *adk.AsyncIterator[*adk.AgentEvent], idle time.Duration, cancels ...func()) (*adk.AgentEvent, bool, error) {
	if events == nil {
	...
	return waitForAsyncResult(ctx, idle, "主循环", cancel, func() (*adk.AgentEvent, bool, error) {
