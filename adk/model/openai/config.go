...
// provider-neutral ADK model contract.
package openai
...
// compatible endpoints to add values without an ADK release.
...
// Per-call ADK options may override MaxTokens and the bound tool surface.
type Config struct {
	APIKey          string
	Model           string
	BaseURL         string
...
// ChatModel implements adk.ToolCallingChatModel against Chat Completions.
...
var _ adk.ToolCallingChatModel = (*ChatModel)(nil)
